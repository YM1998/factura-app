...
import { ATTRIBUTE_GET_ALL, SELLING_POINT_FIND_ALL, SELLING_POINT_FIND_ID } from '../util/enpoints.app';
...
export class SellingPointService {
    ...
    public findAll():Observable<SellingPoint[]> {
        return this.http.get<SellingPoint[]>(SELLING_POINT_FIND_ALL)
                        .pipe(catchError(e=>throwError(e)));
    }
